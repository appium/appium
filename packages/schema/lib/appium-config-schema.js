      ...
      properties: {
        ...
        'use-drivers': {
          appiumCliDescription:
            'A list of drivers to activate. Can be a comma-delimited string or path to CSV file. By default, all installed drivers will be activated. Windows environment may require to wrap the comma-delimited string with quotes to escape the comma.',
          default: [],
          description:
        ...
        'use-plugins': {
          appiumCliDescription:
            'A list of plugins to activate. Can be a comma-delimited string, path to CSV file, or the string "all" to use all installed plugins. Windows environment may require to wrap the comma-delimited string with quotes to escape the comma.',
          default: [],
          description:
