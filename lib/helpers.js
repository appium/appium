...
var functionWarning = _.template(
  "[DEPRECATED] The <%= deprecated %> function has been deprecated and will " +
  "be removed.  Please use the <%= replacement %> function instead."
);

// Send a single deprecation warning to the logger
exports.generateDeprecationWarning = function (kind, deprecated, replacement) {
  return functionWarning({deprecated: deprecated, replacement: replacement});
};
