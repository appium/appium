CHANGES IN VERSION 1.13.1 (FROM 1.13.0)
===================================

Appium 1.13.0 is a patch release. This [addresses problems with long startup times for Safari WebViews on iOS 12.2](https://github.com/appium/appium/issues/12590)

#### Android (Espresso)
* Fix problems with activity startup not working when specifying `appActivity` and `appPackage` [#441](https://github.com/appium/appium-espresso-driver/pull/441)

#### iOS (XCUITest)
* Make `platformVersion` a required capability [#954](https://github.com/appium/appium-xcuitest-driver/pull/954)
