...
| `enforceAppInstall` | Uninstall the installed app and install lower version one in `installApp` when the installed app is equal or greater than the app you would like to install. Defaults to `false`. | `true` , `false` |
