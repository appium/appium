...
exports.setNetworkConnection = function (req, res) {
  ...
  if (checkMissingParams(res, {parameters:parameters}) && checkMissingParams(res, {type: parameters.type})) {
    req.device.setNetworkConnection(req.url, req.body.parameters.type, getResponseHandler(req, res));
  }
};
