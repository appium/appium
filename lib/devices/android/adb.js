...
=======
=======
>>>>>>> fcc2af7... Removed remaining conflict markup
ADB.prototype.startApp = function(pkg, activity, waitActivity, retry, stopApp, cb) {
>>>>>>> ded1aa9... Add an argument to ADB.startApp in order to choose whether to stop the app prior to starting it
=======
ADB.prototype.startApp = function(pkg, activity, waitActivity, retry, stopApp, cb) {
...
<<<<<<< HEAD
<<<<<<< HEAD
>>>>>>> a984106... fix selendroid app launch issues
=======
    stopApp = true;
  } else if (typeof stopApp === "function") {
    cb = stopApp;
...
=======
  var cmd = "am start " + stop + "-a android.intent.action.MAIN -c android.intent.category.LAUNCHER -f 0x10200000 -n " + pkg + "/" + activity;
>>>>>>> 62f6427... Mimick the launcher start intent for the app when starting it
=======
