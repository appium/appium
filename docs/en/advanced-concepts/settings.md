...
|`enableNotificationListener`| For UiAutomator2 Driver. Boolean which set whether Android device should enable or disable `NotificationListener`. `true` by default.  | `false` or `true` |
