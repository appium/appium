...
const deprecatedArgs = [
  ...
  [['--android-coverage-end-intent'], {
    dest: 'androidCoverageEndIntent',
    defaultValue: false,
    required: false,
    example: 'com.example.pkg.END_EMMA',
    deprecatedFor: '--default-capabilities',
    help: '[DEPRECATED] - (Android-only) A broadcast action implemented by yourself which is used ' + 
          'to dump coverage into file system. Passed to -a in adb shell am broadcast -a',
  }],
