...
|`snapshotMaxDepth`| Changes the number of maximum depth for traversing elements source tree. It may help to prevent out of memory while getting the source, but it might restrict the depth of source tree. Defaults to `50` | e.g. `100` | 1.17.0+ |
