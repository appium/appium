...
>>>>>>> 1c6b495... Implementing mobile:background command for Android and Selendroid
=======
>>>>>>> b5dd538... Remove debug log
=======
    console.log("background " + this.appPackage + " " + this.appActivity);
>>>>>>> 209c0e5... Implementing mobile:background command for Android and Selendroid
=======
>>>>>>> 4621e1c... Remove debug log
...
=======
=======
>>>>>>> ac74f2c... Fixed indentation according to Appium project style guide (2 spaces indent)
  this.adb.keyevent("3", function() {
    cb(null, {
      status: status.codes.Success.code
      , value: null
<<<<<<< HEAD
>>>>>>> e60a717... Fixed indentation according to Appium project style guide (2 spaces indent)
    });
  });
  setTimeout(function() {
...
=======
=======
>>>>>>> 29f9e5c... Refactored mobile:background method for Android: using ADB.startApp rather than directly issuing am start command to ADB shell, do not return to callback until app is back to foreground
...
>>>>>>> 0cd14dd... rearchitect configuration methods
androidCommon.background = function (secs, cb) {
  this.adb.getFocusedPackageAndActivity(function (err, pack, activity) {
>>>>>>> d971f72... stricter jshint rules enforcable from editor
    if (err) return cb(err);
    ...
    this.adb.keyevent("3", function (err) {
      ...
      setTimeout(function () {
        this.adb.startApp(this.args.appPackage, this.args.appActivity, pack, activity, true, false, function (err) {
          if (err) return cb(err);
>>>>>>> 2d16152... Implementing mobile:background command for Android and Selendroid
          cb(null, {
            status: status.codes.Success.code
          , value: null
          });
...
<<<<<<< HEAD
>>>>>>> 410f74c... Refactored mobile:background method for Android: using ADB.startApp rather than directly issuing am start command to ADB shell, do not return to callback until app is back to foreground
};
...
=======
      cb(null);
>>>>>>> 82434a5... Support full-reset for selendroid
    }.bind(this));
  }.bind(this);
