...
RemoteDebugger.prototype.selectApp = function (appIdKey, cb, tries) {
  ...
  var runEither = _.once(function () {
    var args = new Args(arguments);
    var fn = args.array.shift();
    fn.apply(null, args.array);
  });

  this.send(connectToApp, runEither.bind(null, onConnect),
    runEither.bind(null, onConnectToBadApp));
};
