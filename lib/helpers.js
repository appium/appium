...
var warningText = _.template(
  ...
  "be removed.  Please use the <%= replacement %> <%= kind %> instead."
);

// Send a single deprecation warning to the logger
exports.generateDeprecationWarning = function (kind, deprecated, replacement) {
  return warningText({kind: kind, deprecated: deprecated,
                      replacement: replacement});
};

exports.produceDeprecationWarning = function (kind, deprecated, replacement) {
  logger.warn(this.generateDeprecationWarning(kind, deprecated, replacement));
};
