...
describe(
  ...
  withSandbox({mocks: {fs, tp, system}}, (S) => {
    it('retrieveInCommonPlaces - success', async function () {
      ...
      (await NodeDetector.retrieveInCommonPlaces()).should.equal(
        '/usr/local/bin/node'
      );
      S.verify();
    });
    ...
    it('retrieveUsingAppleScript - success', async function () {
      ...
      S.mocks.fs.expects('exists').once().returns(B.resolve(true));
      (await NodeDetector.retrieveUsingAppleScript()).should.equal(
        '/a/b/c/d/node'
      );
      S.verify();
    });
    ...
    it('retrieveUsingSystemCall - success - where returns multiple lines ', async function () {
      ...
      S.mocks.fs.expects('exists').once().returns(B.resolve(true));
      (await NodeDetector.retrieveUsingSystemCall()).should.equal(
        '/a/b/node.exe'
      );
      S.verify();
    });
    ...
    it('retrieveUsingAppiumConfigFile - success', async function () {
      ...
      S.mocks.fs
        .expects('readFile')
        .once()
        .returns(B.resolve('{"node_bin": "/a/b/c/d"}'));
      (await NodeDetector.retrieveUsingAppiumConfigFile()).should.equal(
        '/a/b/c/d'
      );
      S.verify();
    });
    ...
    it('retrieveUsingAppiumConfigFile - failure - not json', async function () {
      ...
      S.mocks.fs
        ...
        .once()
        .returns(B.resolve('{node_bin: "/a/b/c/d"}'));
      expect(await NodeDetector.retrieveUsingAppiumConfigFile()).to.be.a(
        'null'
      );
      S.verify();
    });
    ...
    it('checkForNodeBinary - success', async function () {
      ...
      S.mocks.NodeDetector.expects('retrieveInCommonPlaces')
        .once()
        .returns(null);
      S.mocks.NodeDetector.expects('retrieveUsingSystemCall')
        .once()
        .returns(null);
      S.mocks.NodeDetector.expects('retrieveUsingAppleScript').returns(
        '/a/b/c/d'
      );
    ...
    it('checkForNodeBinary - failure', async function () {
      ...
      S.mocks.NodeDetector.expects('retrieveUsingSystemCall')
        .once()
        .returns(null);
      S.mocks.NodeDetector.expects('retrieveUsingAppleScript')
        .once()
        .returns(null);
      S.mocks.NodeDetector.expects('retrieveUsingAppiumConfigFile')
        .once()
        .returns(null);
