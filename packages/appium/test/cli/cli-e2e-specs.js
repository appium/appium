...
import { installLocalExtension, runAppium, runAppiumJson } from './cli-helpers';
  ...
  describe('when appium is a dependency', function () {
    ...
    describe('when a driver is installed via npm', function () {
      ...
      describe('when a different driver is installed via appium', function () {
        const testDriverPath = path.join(__dirname, 'fixtures', 'test-driver');
        /** @type {string} */
        let oldHash;
        /** @type {string} */
        let oldPkg;
 ...
 * @typedef {import('./cli-helpers').CliArgs} CliArgs
 * @typedef {import('../../types/types').CliExtensionSubcommand} CliExtensionSubcommand
 */

/**
 * @template ExtSubCommand
 * @typedef {import('./cli-helpers').CliExtArgs<ExtSubCommand>} CliExtArgs
 */
