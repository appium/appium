...
async function unzipApp (zipPath, appExt) {
  ...
  let {stdout} = await exec('find', [path.dirname(zipPath), '-type', 'd', '-name', `*${appExt}`]);
...
export {
  configureApp, downloadApp, downloadFile, copyLocalZip, unzipApp, unzipFile,
  testZipArchive, isPackageOrBundle, getCoordDefault, getSwipeTouchDuration,
  copyFromWindowsNetworkShare, renameKey,
};
