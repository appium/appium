...
var winston = require('winston')
  ...
  , path = require('path')
  , util = require('util')
  , tmp = require('appium-support/lib/tempdir')
...
var tmpfile = tmp.path() + path.sep + timestamp();
...
var _createTransports = function (args) {
  ...
  transports.push(_createTmpFileTransport(tmpfile, consoleLogLevel));
...
module.exports.getServerLog = function () {
  var logs = [];
  var data = fs.readFileSync(tmpfile, 'utf8');
