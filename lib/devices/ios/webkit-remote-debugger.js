...
var WebKitRemoteDebugger = function (logColors, onDisconnect, webkitDebugPort) {
  this.dataMethods = {};
  this.host = 'localhost';
  this.port = webkitDebugPort;
  console.log('Testing console!!!!!XXXXXXX!!!!!!!!!XXXXXXX!!!!!\n !!!!!XXXXX\n XXXXXXXXX!!!!!!!!!!');
...
exports.init = function (logColors, onDisconnect, webkitPort) {
  console.log("WwebkitPort = " + webkitPort);
  return new WebKitRemoteDebugger(logColors, onDisconnect, webkitPort);
};
