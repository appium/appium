...
import { getPkgObject } from './utils';
import logger from './logger';

const pkgObj = getPkgObject();
...
async function getGitRev () {
  ...
  // Check if we're in the right folder, relative to package.json
  if (!await fs.exists(path.resolve(cwd, 'package.json'))) {
