...
const deprecatedArgs = [
  ...
  [['--platform-name'], {
    ...
    default: null,
    required: false,
    help: '[DEPRECATED, use --default-capabilities instead] - ' +
  ...
  [['--device-name'], {
    ...
    required: false,
    help: '[DEPRECATED, use --default-capabilities instead] - ' +
          'Name of the mobile device to use, for example: ' +
  ...
  [['--language'], {
    ...
    dest: 'language',
    required: false,
    help: '[DEPRECATED, use --default-capabilities instead] - Language for the ' +
          'iOS simulator / Android Emulator, like: en, es',
  }],
  ...
  [['--locale'], {
    ...
    dest: 'locale',
    required: false,
    help: '[DEPRECATED, use --default-capabilities instead] - Locale for the iOS ' +
          'simulator / Android Emulator, like en_US, de_DE',
  }],
  ...
  [['-U', '--udid'], {
    ...
    required: false,
    default: null,
    help: '[DEPRECATED, use --default-capabilities instead] - Unique device identifier ' +
          'of the connected physical device',
  }],
  ...
  [['--orientation'], {
    ...
    required: false,
    help: '[DEPRECATED, use --default-capabilities instead] - ' +
          '(IOS-only) use LANDSCAPE or PORTRAIT to initialize all requests ' +
          'to this orientation',
  }],
  ...
  [['--no-reset'], {
    ...
    action: 'store_true',
    required: false,
    help: '[DEPRECATED, use --default-capabilities instead] - Do not reset app ' +
          'state between sessions (IOS: do not delete app ' +
  ...
  [['--full-reset'], {
    ...
    required: false,
    help: '[DEPRECATED, use --default-capabilities instead] - ' +
          '(iOS) Delete the entire simulator folder. (Android) Reset app ' +
  ...
  [['--app-pkg'], {
    ...
    required: false,
    help: '[DEPRECATED, use --default-capabilities instead] - ' +
          '(Android-only) Java package of the Android app you want to run ' +
  ...
  [['--app-activity'], {
    ...
    default: null,
    required: false,
    help: '[DEPRECATED, use --default-capabilities instead] - (Android-only) ' +
          'Activity name for the Android activity you want ' +
  ...
  [['--app-wait-package'], {
    ...
    default: false,
    required: false,
    help: '[DEPRECATED, use --default-capabilities instead] - (Android-only) Package ' +
          'name for the Android activity you want ' +
  ...
  [['--app-wait-activity'], {
    ...
    default: false,
    required: false,
    help: '[DEPRECATED, use --default-capabilities instead] - (Android-only) Activity ' +
          'name for the Android activity you want ' +
  ...
  [['--device-ready-timeout'], {
    ...
    required: false,
    type: 'int',
    help: '[DEPRECATED, use --default-capabilities instead] - (Android-only) Timeout ' +
          'in seconds while waiting for device to become ready',
  }],
  ...
  [['--android-coverage'], {
    ...
    default: false,
    required: false,
    help: '[DEPRECATED, use --default-capabilities instead] - (Android-only) Fully ' +
          'qualified instrumentation class. Passed to -w in ' +
  ...
  [['--avd'], {
    ...
    default: null,
    required: false,
    help: '[DEPRECATED, use --default-capabilities instead] - (Android-only) Name of ' +
          'the avd to launch (e.g. @Nexus_5)',
  }],
  ...
  [['--avd-args'], {
    ...
    default: null,
    required: false,
    help: '[DEPRECATED, use --default-capabilities instead] - (Android-only) Additional ' +
          'emulator arguments to launch the avd (e.g. -no-snapshot-load)',
  }],
  ...
  [['--use-keystore'], {
    ...
    action: 'store_true',
    required: false,
    help: '[DEPRECATED, use --default-capabilities instead] - (Android-only) When set ' +
          'the keystore will be used to sign apks.',
  }],
  ...
  [['--keystore-path'], {
    ...
    dest: 'keystorePath',
    required: false,
    help: '[DEPRECATED, use --default-capabilities instead] - (Android-only) Path to keystore',
  }],
  ...
  [['--keystore-password'], {
    ...
    required: false,
    help: '[DEPRECATED, use --default-capabilities instead] - (Android-only) Password to keystore',
  }],
  ...
  [['--key-alias'], {
    ...
    dest: 'keyAlias',
    required: false,
    help: '[DEPRECATED, use --default-capabilities instead] - (Android-only) Key alias',
  }],
  ...
  [['--key-password'], {
    ...
    dest: 'keyPassword',
    required: false,
    help: '[DEPRECATED, use --default-capabilities instead] - (Android-only) Key password',
  }],
  ...
  [['--intent-action'], {
    ...
    required: false,
    help: '[DEPRECATED, use --default-capabilities instead] - (Android-only) Intent action ' +
          'which will be used to start activity (e.g. android.intent.action.MAIN)',
  }],
  ...
  [['--intent-category'], {
    ...
    required: false,
    help: '[DEPRECATED, use --default-capabilities instead] - (Android-only) Intent ' +
          'category which will be used to start activity ' +
  ...
  [['--intent-flags'], {
    ...
    default: '0x10200000',
    required: false,
    help: '[DEPRECATED, use --default-capabilities instead] - (Android-only) Flags that ' +
          'will be used to start activity (e.g. 0x10200000)',
  }],
  ...
  [['--intent-args'], {
    ...
    required: false,
    help: '[DEPRECATED, use --default-capabilities instead] - (Android-only) Additional ' +
          'intent arguments that will be used to start activity  (e.g. 0x10200000)',
  }],
  ...
  [['--dont-stop-app-on-reset'], {
    ...
    action: 'store_true',
    required: false,
    help: '[DEPRECATED, use --default-capabilities instead] - (Android-only) When included, ' +
          'refrains from stopping the app before restart',
  }],
  ...
  [['--calendar-format'], {
    ...
    dest: 'calendarFormat',
    required: false,
    help: '[DEPRECATED, use --default-capabilities instead] - (IOS-only) calendar format for ' +
          'the iOS simulator (e.g. gregorian)',
  }],
  ...
  [['--native-instruments-lib'], {
    ...
    action: 'store_true',
    required: false,
    help: '[DEPRECATED, use --default-capabilities instead] - (IOS-only) IOS has a weird built-in unavoidable ' +
  ...
  [['--keep-keychains'], {
    ...
    action: 'store_true',
    required: false,
    help: '[DEPRECATED, use --default-capabilities instead] - (iOS-only) Whether to keep keychains ' +
  ...
  [['--localizable-strings-dir'], {
    ...
    default: 'en.lproj',
    help: '[DEPRECATED, use --default-capabilities instead] - (IOS-only) the relative path of ' +
          'the dir where Localizable.strings file resides (e.g. en.lproj)',
  }],
  ...
  [['--show-ios-log'], {
    ...
    action: 'store_true',
    required: false,
    help: '[DEPRECATED, use --default-capabilities instead] - (IOS-only) if set, the iOS system ' +
          'log will be written to the console',
  }],
  ...
  [['--async-trace'], {
    ...
    required: false,
    action: 'store_true',
    help: '[DEPRECATED, use --long-stacktrace instead] - Add long stack traces to log entries. ' +
  ...
  [['--chromedriver-port'], {
    ...
    required: false,
    type: 'int',
    help: '[DEPRECATED, use --default-capabilities instead] - Port upon which ChromeDriver will run. If not given, ' +
...
function updateParseArgsForDefaultCapabilities (parser) {
  ...
  parser.parseArgs = function parseArgs (args) {
    ...
    for (let argEntry of deprecatedArgs) {
      ...
      if (_.every(['--default-capabilities', 'DEPRECATED'], (x) => _.includes(argEntry[1].help, x))) {
