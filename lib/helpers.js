...
exports.addDeprecationWarning = function (kind, deprecated, replacement) {
...
exports.emitDeprecationWarnings = function () {
  _.each(exports.getDeprecationWarnings(), function (warning) {
    logger.warn(warning);
  });
};
