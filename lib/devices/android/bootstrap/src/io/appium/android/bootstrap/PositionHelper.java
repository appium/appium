...
public abstract class PositionHelper {
   ...
   * @return
   */
  private static double _translateCoordinate(double pointCoord, double length, double offset) {
  ...
  public static Point getAbsolutePosition(final Point point, final Rect displayRect, 
    ...
    absolutePosition.x = _translateCoordinate(point.x, displayRect.width(), offsets.x);
    absolutePosition.y = _translateCoordinate(point.y, displayRect.height(), offsets.y);
