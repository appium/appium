...
Selendroid.prototype.setNetworkConnection = function (url, type, cb) {
  ...
  var airplaneMode = type % 2 === 1;
  this.proxyTo(url, "GET", null, function (err, res, body) {
    if (err || res.statusCode === 500) {
      ...
      if ((currentType % 2 === 1) === airplaneMode) {
        ...
        cb(null, {status: status.codes.Success.code, value: body});
      } else {
        ...
        var response = {status: status.codes.Success.code, value: airplaneMode? 1: 6};
