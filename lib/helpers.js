...
function validateLocatorStrategy (strategy, webContext = false) {
  ...
  if (!_.contains(validStrats, strategy)) {
    throw new errors.UnknownCommandError(`Locator Strategy: ${strategy} is not supported for this session`);
  }
}

export default {configureApp, downloadApp, downloadFile, copyLocalZip,
                unzipApp, unzipFile, testZipArchive, validateLocatorStrategy};
