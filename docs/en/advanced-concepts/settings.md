...
|`useFirstMatch` | Enabling this setting makes a single element lookups faster, but there is the known problem, [issue](https://github.com/appium/appium/issues/10101), about nested elements lookup. Defaults to `false`. |`true`, `false` |1.15.0+|
