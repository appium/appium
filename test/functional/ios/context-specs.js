...
var setup = require("../common/setup-base")
  , desired = require('./desired').webview
  , _ = require('underscore')
  , env = require('../../helpers/env');

describe('ios - contexts', function () {
  ...
  it('getting current context should return NATIVE_APP when none set', function (done) {
    driver
      .currentContext()
        .should.eventually.equal("NATIVE_APP")
      .nodeify(done);
  });
  ...
  it('returning to \'NATIVE_APP\' should work', function (done) {
    driver
      ...
      .currentContext()
        .should.eventually.not.equal('NATIVE_APP')
      .context('NATIVE_APP')
      .currentContext()
        .should.eventually.equal('NATIVE_APP')
      .nodeify(done);
