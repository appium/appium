/*global au:true $:true codes:true UIAElementNil:true UIATarget:true */
"use strict";
...
$.extend($.fn, {
  ...
  , matchesTagName: function(tagName) {
      var type = this.type();
  ...
  , matchesBy: function(tagName, text) {
  ...
  , touchFlick: function(xoffset, yoffset) {
      var options = {
            startOffset : {
                x : 0.5,
                y : 0.5
