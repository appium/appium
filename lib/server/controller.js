...
// our multitouch API and our `mobile` script API are incompatible, so we need 2 different impelementations
exports.mobileSwipeScript = function (req, res) {
  req.body = _.defaults(req.body, {
    touchCount: 1
    , startX: 0.5
    , startY: 0.5
...
, 'swipe': exports.mobileSwipeScript
