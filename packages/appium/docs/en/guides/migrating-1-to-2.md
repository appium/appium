...
This will install Appium and the two drivers for you in one go. Please uninstall Appium 1.x npm package once if you get an error in the installation or Appium process failure. 
