...
| `acceptAlertButtonSelector` | Allow to customize accept alert button selector as class chain locator. Defaults to find a button as class type of `XCUIElementTypeAlert`. | <code>**/XCUIElementTypeButton[`label CONTAINS[c] 'accept'`]</code> |
| `dismissAlertButtonSelector` | Allow to customize dismiss alert button selector as class chain locator. Defaults to find a button as class type of `XCUIElementTypeAlert`. | <code>**/XCUIElementTypeButton[`label CONTAINS[c] 'dismiss'`]</code> |
