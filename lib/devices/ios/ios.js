...
IOS.prototype.init = function (args, caps) {
  ...
  this.autoAcceptAlerts = !!args.autoAcceptAlerts;
...
IOS.prototype.makeInstruments = function () {
  return new Instruments({
    app: this.args.app || this.bundleId
  , udid: this.udid
...
IOS.prototype.setDeviceAndLaunchSimulator = function (cb) {
  ...
  if (this.udid) {
    ...
    cb();
  } else if (!this.args.app && this.bundleId) {
