...
Device.prototype.getCachedContext = function (name) {
  return this.contextCache[name];
};

Device.prototype.cacheContext = function (name, context) {
  this.contextCache[name] = context;
};

Device.prototype.destroyContexts = function () {
