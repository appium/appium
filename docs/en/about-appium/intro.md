...
a cloud service like [Sauce Labs](https://saucelabs.com/products/mobile-app-testing), [LambdaTest](https://www.lambdatest.com/feature) or [TestingBot](https://testingbot.com/mobile/realdevicetesting) to receive and
