...
iOSController.performTouch = function (gestures, cb) {
  iOSController.parseTouch.apply(this, [gestures, function (touchStateObjects) {
...
iOSController.parseTouch = function (gestures, cb) {
  ...
  var action = function () {
    var prevPos = null;
    console.log(completed + "/" + gestures.length);
...
var mergeStates = function (states) {
  ...
  var timeSequence = function (states) {
    ...
    return _.sortBy(seq, function (time) { return time; });
  };
