...
|`nativeWebTap`| Accept or reject "real", non-javascript-based web popups in Safari. Default: `false`. Warning: depending on viewport size/ratio; this might not accurately tap an element|`true` or `false`|
