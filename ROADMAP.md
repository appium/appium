...
|---------|-------------|-----------|----------------|-------|
|[Onboarding Overhaul](https://github.com/appium/appium/issues/7169)|We have a new site built with MkDocs that documents all of the Selenium and Appium commands with code samples|1/2018|1.6.4||
|[Appium Dearchitecture](https://github.com/appium/appium/issues/7169)|We have a new site built with MkDocs that documents all of the Selenium and Appium commands with code samples|1/2018|1.6.4||
