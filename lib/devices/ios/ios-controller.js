...
iOSController.scroll = function (elementId, direction, cb) {
  // call scrollLeft, scrollRight, scrollUp, and scrollDown on the element. 
  console.log(direction);
  var command = ["au.getElement('", elementId, "').scroll", direction.charAt(0).toUpperCase(), direction.slice(1), "()"].join('');
  this.proxy(command, cb);
};
