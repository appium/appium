...
commands.getTimeouts = async function () { // eslint-disable-line require-await
  return {
...
helpers.setImplicitWait = function (ms) { // eslint-disable-line require-await
...
commands.pageLoadTimeoutW3C = async function (ms) { // eslint-disable-line require-await
  throw new errors.NotImplementedError('Not implemented yet for pageLoad.');
};

// eslint-disable-next-line no-unused-vars
commands.pageLoadTimeoutMJSONWP = async function (ms) { // eslint-disable-line require-await
  throw new errors.NotImplementedError('Not implemented yet for pageLoad.');
};

// script
// eslint-disable-next-line no-unused-vars
commands.scriptTimeoutW3C = async function (ms) { // eslint-disable-line require-await
  throw new errors.NotImplementedError('Not implemented yet for script.');
};

// eslint-disable-next-line no-unused-vars
commands.scriptTimeoutMJSONWP = async function (ms) { // eslint-disable-line require-await
  throw new errors.NotImplementedError('Not implemented yet for script.');
};

// command
commands.newCommandTimeout = async function (ms) { // eslint-disable-line require-await
