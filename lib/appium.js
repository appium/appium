...
class AppiumDriver extends BaseDriver {
  ...
  getDriverForCaps (caps) {
    ...
    if (_.isUndefined(caps.automationName)) {
      log.warn(`DeprecationWarning: "automationName" was not provided in the desired capabilities. ` +
        `Future versions of Appium will require "automationName" capability to be set explicitly.`);
    }
